...
void CMenuOptions::_Init( void )
{
	...
	AddButton( L( "Controls" ), L( "Change VR controllers settings." ),
		PC_CONTROLS, UI_VR_Controls, QMF_NOTIFY );
	AddButton( L( "VR" ), L( "Change VR specific settings." ), PC_VR, UI_VR_Menu, QMF_NOTIFY );
